         ...
         {conSearchList.map((item, i) => 
            <div key={i} className='flex flex-col md:border items-center overflow-hidden'>
               ...
               <figure className='order-2'>
                  ...
                  <Img id="op" src={[`https://static01.nyt.com/${item.multimedia[0].url}`, `https://static01.nyt.com/${item.multimedia[1].url}`, `https://static01.nyt.com/${item.multimedia[2].url}`]} className='lg:hover:opacity-70 mb-5 h-[14rem] w-full' loader={<ImageLoader />} unloader={<ImageUnLoader />} />
